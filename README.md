...
- **Sort**: Users can sort bots by health, damage, or armor attributes.
...
5. Open the app in your browser:
   ...
   http://localhost:5173/
   ```
6. Deploy the frontend to Netlify and the db.json to render 
---

## File Structure

### Key Files
- **` src/App.jsx`**: The main application component manages the state and renders the app.
